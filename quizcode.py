...
#we have to load the voice of our choice to use it in phone a friend to speak the answer
...
select_call_button=Button(root,image=callimage,bd=0,bg='black',activebackground='black',cursor='hand2',command=phoneclick)
...
amountimage = PhotoImage(file="Picture1.png")
...
amountImages = [amountimage1, amountimage2, amountimage3,amountimage4, amountimage5,amountimage6, amountimage7, amountimage8, amountimage9, amountimage10,
